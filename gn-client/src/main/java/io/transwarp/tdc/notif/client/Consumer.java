...
import io.transwarp.tdc.notif.common.NConsumerRecords;
import io.transwarp.tdc.notif.common.OffsetAndMetadata;
import io.transwarp.tdc.notif.common.TopicPartition;
...
public interface Consumer<T> {
     ...
     */
    NConsumerRecords<T> poll(long timeoutMillis);
